...
void reset_the_Data() 
{
  ...
  received_data.ch1 = 80;      //Throttle (channel 1) to 0
  received_data.ch2 = 127;
  received_data.ch3 = 127;
  received_data.ch4 = 127;
  received_data.ch5 = 0; // Fall back setting Please set it to LAND / RTL mode 
                           // so that Quad can land safely instead of
                           // turning off throttle. the maped PWM value is 1688
  received_data.ch6 = 0;
...
/////////////////////////////////////////////////////////////////////////
  ...
  if ( now - lastRecvTime > 1000 ) {
    ...
    //fly away
    ch5_value = map(169,0,255,1000,2000);// Fall back setting Please set it to LAND / RTL mode 
                           // so that Quad can land safely instead of
                         // turning off throttle. the maped PWM value is 1688
  } 
